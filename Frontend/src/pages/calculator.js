...
<section id="calcApp" class="max-w-[1180px] mt-4 mb-10
            bg-gradient-to-b from-white to-gray-50
            rounded-2xl p-6 grid grid-cols-1 gap-6
            md:grid-cols-[420px_1fr] shadow-[0_10px_30px_rgba(0,0,0,.04),_inset_0_1px_0_#fff]">
